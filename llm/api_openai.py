...
app = FastAPI(
    title="Coupon Chatbot API (OpenAI)",
    description="A LangChain-powered API for finding and recommending coupons from SimplyCodes.com using OpenAI GPT models",
    version="1.0.0"
)
...
async def root():
    ...
    return {
        "message": "Coupon Chatbot API (OpenAI)",
        "version": "1.0.0",
        "status": "running",
        "model": "OpenAI GPT",
        "endpoints": {
